...
- <img src="https://img.shields.io/badge/Kubernetes-326CE5?style=flat&logo=kubernetes&logoColor=white" alt="Kubernetes" height="20"/>

## Мои проекты

### Gamehub
Основной проект над который я работаю - это GameHub. Социальная сеть для геймеров на подобии LiveLib. Связанные с этим проектом репозитории:
- [Сервис-справочник игр](https://github.com/sariya23/game_service). Отвечает за CRUD-операции.
- [Сервис-sso](https://github.com/sariya23/auth_service). Отвечает за регистрацию и аутентификацию пользователей.
- [Gateway](https://github.com/sariya23/api_gateway). Единая точка входа, роутинг и баласинг
